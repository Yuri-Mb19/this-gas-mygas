                                    ...
                                    <div class="header-content" id="menuids">
                                        ...
                                        <nav class="header-nav-wrap">
                                            ...
                                            <!--        <ul class="sub-menu">
                                                ...
                                                <li><a href="{{ route('site.sobre-nos') }}" title="" id="sobrenos">{{__('messages.sobrenoss')}}</a></li>
                                                    <li>
                                                        <!-- Mudar lingua -->
        ...
        <div id="banner-section" class="page-title" data-jarallax='{"speed": 0.6}' style="background: url(assets/images/banner/hero-04.jpg);">
            <div class="overlay">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrubms text-center" id="tornarevendedorpai">
                                <h2 class="title" id="sobrenos">{{__('messages.tornarevendedorpai')}}</h2>
                                <ul class="d-flex justify-content-center mt-20">
                                    <li class="mb-20"><a href="{{ route('site.index') }}">Home</a></li>
                                    <li> / </li>
                                    <li><span class="active" id="abarevendedor">{{__('messages.abarevendedor')}}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script>
  ...
  // Function to set the language of the webpage
      function setLanguage() {
        ...
        $("#tornarevendedorpai #tornarevendedor ").text(translations[langCode]["tornarevendedor"]);
      }
