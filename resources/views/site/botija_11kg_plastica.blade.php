                                        ...
                                        <nav class="header-nav-wrap">
                                            ...
                                            <ul class="header-nav">
                                                ...
                                                <!--    <li class="">
                                                    ...
                                                    <li class="">
                                                        <a href="{{ route('site.revendedores') }}" title="" >{{__('messages.renvendedores')}}</a>
                                                <!--        <ul class="sub-menu">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrubms text-center">
                                <h2 class="title">Detalhes da Botija de 11KG (PLASTICA)</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                        ...
                        <div class="blog-content style-01 mt-30">
                            <div class="thumb">
                                <a href="#"><img src="assets/images/botija_plastica.png" alt="blog image"></a>
                            </div>
                            ...
                            <h3 class="title mt-40"><a href="#" id="45kg"> Botija de 11KG (PLASTICA) </a></h3>
                            <p class="text mt-20" id="5kgcontent">
							    {{__('messages.11plastica1')}}
                                <br>
                                {{__('messages.11plastica2')}}	
                                <br>
                                {{__('messages.11plastica3')}}	
                                <br>
                                {{__('messages.11plastica4')}}	
                                <br>
                                {{__('messages.11plastica5')}}	
  ...
  // Function to set the language of the webpage
      function setLanguage() {
        ...
        $("#rvendtornar ").text(translations[langCode]["rvendtornar"]);
         $("#45kgcontent ").text(translations[langCode]["45kgcontent"]);
      }
