        ...
        <div id="banner-section" class="page-title" data-jarallax='{"speed": 0.6}' style="background: url(assets/images/banner/hero-04.jpg);">
            <div class="overlay">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrubms text-center"  id="sbrNosx">
                                <h2 class="title" id="sbrNos">{{__('messages.sbrNos')}}</h2>
                                <ul class="d-flex justify-content-center mt-20">
                                    ...
                                    <li> / </li>
                                    <li><span class="active"  id="sbrNos">{{__('messages.sbrNos')}}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                        ...
                        <div class="blog-content style-01 mt-30" id="sbrNosnew">
                        
                            
                            <h4 class="text mt-50" id="sbrNos"><b>{{__('messages.sbrNos')}}</b></h4>
                            <p class="text mt-20" id="abt1">
                             ...
                             <h4 class="text mt-50" id="sbrNos2"><b>{{__('messages.sbrNos2')}}</b></h4>
                            <p class="text mt-20"  id="abt2">
                                
                                
                                {{__('messages.abt2')}}
                             </p>
                             <br>
                              <h4 class="text mt-50" id="sbrNos3"><b>{{__('messages.sbrNos3')}}</b></h4>
                            <p class="text mt-20"  id="abt3">
                             ...
                             <br>
                              <p class="text mt-20"  id="abt4">
                             
                                {{__('messages.abt4')}}
                            </p>
                             
                            <br><br>
                            <p class="text mt-20"  id="abt5">
                            ...
                            <br> <br>
                            	<strong>  {{__('messages.subri2')}}</strong> <br> <br>
                            
                                {{__('messages.subri3')}} <br> <br>
                            
                                {{__('messages.subri4')}}<br> <br>
                            
                            
                            <strong> {{__('messages.subri5')}}  </strong><br> <br>
                            {{__('messages.subri6')}}  <br> <br>
                            {{__('messages.subri7')}}  <br> <br>
                            ⦁<strong>	  {{__('messages.subri8')}}  </strong><br> <br>
                            {{__('messages.subri9')}}<br> <br>
