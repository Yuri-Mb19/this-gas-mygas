...
<body id="default-home">
    ...
    <main>
        ...
        <!-- Banner end     \App\Product::where(['id' => $product->id])->first()->avatar;-->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                        ...
                        <div class="blog-content style-01 mt-30">
                            <div class="thumb">
                                <a href=""><img src="/images/{{$product->image}}" width="770" height="450" alt="blog image"></a>
                            </div>
                            ...
                            <h3 class="title mt-40"><a href="" id="osbeneficios">{{ $product->name }} </a></h3>
                            <p class="text mt-20" id="contentproduct1">
                                {{ $product->detail }}
								<br><br>
                              ...
                              <div class="widget recentPostss">
								...
								<li>
										<a href="{{ route( 'site.noticias_2' )}}">
											<h5 id="osbeneficios2">{{ __('messages.osbeneficios2')}}</h5>
										</a>
...
<script>
  ...
  // Function to set the language of the webpage
      function setLanguage() {
        ...
        $("#contentproduct1").text(translations[langCode]["contentproduct1"]);
      }
