                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrubms text-center">
                                <h2 class="title">Detalhes da Botija de 11KG (COMPACT/POL)</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                        ...
                        <div class="blog-content style-01 mt-30">
                            <div class="thumb">
                                <a href="#"><img src="assets/images/botija_pol_11kg.png" alt="blog image"></a>
                            </div>
                            ...
                            <h3 class="title mt-40"><a href="#" id="5kg" > Botija de 11KG (COMPACT/POL) </a></h3>
                            <p class="text mt-20" id="5kgcontent">
                                {{__('messages.11kgpo0')}}
								<br>
								<br>
								<strong>{{__('messages.p1')}}</strong> {{__('messages.11kgpo1')}}
								<br>
								<br>
								<strong>{{__('messages.p2')}}</strong> {{__('messages.11kgpo2')}}
								<br>
								<br>
								<strong>{{__('messages.p3')}}</strong>  {{__('messages.11kgpo3')}}
								<br>
								<br>
								<strong>{{__('messages.p4')}}</strong> {{__('messages.11kgpo4')}}
								<br>
								<br>
								{{__('messages.11kgpo5')}}
                            ...
                            <ul class="d-flex mt-20">
                                ...
                                <li>
                                    <a href="{{ route( 'site.noticias_1' )}}">
                                        <h5 id="osbeneficioss">{{__('messages.osbeneficios')}}</h5>
                                    </a>
                                    <span>Março 5, 2023</span>
                                </li>
                            </ul>
  ...
  // Function to set the language of the webpage
      function setLanguage() {
        ...
        $("#rvendtornar ").text(translations[langCode]["rvendtornar"]);
         $("#11kgpcontent ").text(translations[langCode]["11kgpcontent"]);
      }
