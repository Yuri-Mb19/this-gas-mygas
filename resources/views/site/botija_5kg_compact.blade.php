                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrubms text-center">
                                <h2 class="title">Detalhes da Botija de 5KG (COMPACT)</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                        ...
                        <div class="blog-content style-01 mt-30">
                            <div class="thumb">
                                <a href="#"><img src="assets/images/botija_5kg.png" alt="blog image"></a>
                            </div>
                            ...
                            <p class="text mt-20" id="5kgccontent">

                                {{__('messages.5kgccontent1')}}
                                <br>
                                {{__('messages.5kgccontent2')}}
                                <br>
                                {{__('messages.5kgccontent3')}}
                                <br>

								 </p>
								<p class="text mt-20">

                                {{__('messages.5kgccontent4')}}
                            </p>
                       ...
                       <div class="col-lg-4">
                        <div class="blog-sidebar-wrapper pl-30 xs-pl-0 sm-pl-0 md-pl-0 mt-30 md-mt-50 xs-mt-50">
                              ...
                              <div class="widget recentPostss">
                                <h3 class="title">{{__('messages.recentPosts')}}</h3>
                            ...
                            <ul class="d-flex mt-20">
                                ...
                                <li>
                                    <a href="{{ route( 'site.noticias_1' )}}">
                                        <h5 id="osbeneficioss">{{__('messages.osbeneficioss')}}</h5>
                                    </a>
                                    <span>Março 5, 2023</span>
                                </li>
                            </ul>
  ...
  // Function to set the language of the webpage
      function setLanguage() {
        ...
        $("#rvendtornar ").text(translations[langCode]["rvendtornar"]);
         $("#5kgcontent ").text(translations[langCode]["5kgcontent"]);
      }
