...
<body id="default-home">
    ...
    <main>
        ...
        <!-- Banner start -->
        <div id="banner-section" class="page-title" data-jarallax='{"speed": 0.6}' style="background: url(assets/images/planta2.jpg);">
            <div class="overlay">
                <div class="container">
                    <div class="row">
                         <div class="col-lg-12">
                            <div class="breadcrubms text-center" id="ninformativass">
                                <h2 class="title" id="ninformativas">{{__('messages.ninformativas')}}</h2>
                                <ul class="d-flex justify-content-center mt-20">
                                    <li class="mb-20"><a href="{{ route('site.index') }}" id="abaprincipal">Principal</a></li>
                                    <li> / </li>
                                    <li><span class="active" id="ninformativas"> {{__('messages.ninformativas')}}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                        ...
                        <div class="blog-content style-01 mt-30">
                            <div class="thumb">
                                <a href="#"><img src="/images/{{ $product2->image }}" width="770" height="450"  alt="blog image"></a>
                            </div>
                            ...
                            <h3 class="title mt-40"><a href="#"  id="osbeneficios2"> {{ $product2->name }} </a></h3>
                            <p class="text mt-20"  id="contentproduct2">	
                                {{ $product2->detail }}
							</p>
                              ...
                              <div class="widget recentPostss">
								...
								<li>
										<a href="{{ route( 'site.noticias_1' )}}">
											<h5 id="osbeneficios">{{__('messages.osbeneficios')}}</h5>
										</a>
								...
								<li>
										<a href="{{ route( 'site.noticias_3' )}}">
											<h5 id="osbeneficios3">{{__('messages.osbeneficios3')}}</h5>
										</a>
										<span>Março 5, 2023</span>
									</li>
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="footer-widget widget mt-50">
                            ...
                            <ul class="mt-20">
                                ...
                                <li><a href="{{ route('site.produto')}}"><i class="fa fa-angle-right" id="produtosabaprodutos"></i>{{__('messages.abaprodutos')}}</a></li>
  ...
  // Function to set the language of the webpage
      function setLanguage() {
        ...
        $("#langButton").text(translations[langCode]["contactenos"]);
         $("#sbrNosnew #sbrNos").text(translations[langCode]["sbrNos"]);
        ...
        $("#ninformativass #ninformativas").text(translations[langCode]["ninformativas"]);
        $("#contentproduct2").text(translations[langCode]["contentproduct2"]);
      }
