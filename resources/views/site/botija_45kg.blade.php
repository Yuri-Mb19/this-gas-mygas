                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="breadcrubms text-center">
                                <h2 class="title">Detalhes da Botija de 45KG (COMPACT/POL)</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12">
                        ...
                        <div class="blog-content style-01 mt-30">
                            <div class="thumb">
                                <a href="#"><img src="assets/images/botija_45kig.png" alt="blog image"></a>
                            </div>
                            ...
                            <h3 class="title mt-40"><a href="#" id="11kg" > Botija de 45KG (COMPACT/POL) </a></h3>
                            <p class="text mt-20" id="45kgcontent">
							{{__('messages.45kg')}}
  ...
  // Function to set the language of the webpage
      function setLanguage() {
        ...
        $("#rvendtornar ").text(translations[langCode]["rvendtornar"]);
          $("#11kgcontent ").text(translations[langCode]["11kgcontent"]);
      }
