...
<body id="default-home" onload="setLanguage()">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-12">
                        <div class="logo-wrapper">
                            <a href="###" class="logo"><img src="{{ asset('assets/images/MyGas_mocambique.jpg')}}" alt=""></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <select class="form-control changeLang">
                            <option value="en" {{ session()->get('locale') == 'en' ? 'selected' : '' }}>Portugues</option>
                            <option value="fr" {{ session()->get('locale') == 'fr' ? 'selected' : '' }}>Inglesh</option>
                        </select>
                    </div>
                </div>     
            </div>
                        ...
                        <div class="header-main-menu">
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-12 d-block d-sm-block d-md-block d-lg-none d-xl-none d-xxl-none">
                                    <div class="logo-wrapper">
                                        <a href="###" class="logo"><img src="assets/images/MyGas_mocambique.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-8 col-md-2 col-12">
                                    <div class="header-content" id="menuids">
                                        ...
                                        <nav class="header-nav-wrap">
                                            ...
                                            <ul class="header-nav">
                                                <li><a href="###" title="" id="abaprincipal">{{__('messages.abaprincipal')}}</a></li>
                                            ...
                                            <!--       <ul class="sub-menu">
                                                ...
                                                <li><a href="{{ route('site.sobrenos') }}" title="" id="sobrenos">{{__('messages.sobrenos')}}</a></li>
    ...
    <main>
        ...
        <!-- Hero start -->
         ...
         <!--   <div class="hero-bg-01" data-jarallax='{"speed": 0.6}' style="background-image:url(assets/images/camping.jpg);">  -->
		  <div class="hero-bg-01" data-jarallax='{"speed": 0.6}' style="background-image:url(assets/images/banner/hero-04.jpg);" id="slideshowgrid">
                <div class="overlay">
                    <div class="container">
                            ...
                            <div class="col-lg-12">
                                <div class="hero-content-one" id="treesolucao">
                                    ...
                                    <div class="hero-btn mt-50 xs-mt-30">
                                        <a href="{{ route('site.sobrenos') }}" class="btn btn-secondary xs-mt-10">
                                            <i class="flaticon-right icon-arrow before"></i>
			...
			<div class="hero-bg-01" data-jarallax='{"speed": 0.6}' style="background-image:url(assets/images/menu/imgonline-com-ua-resize-VU4wwHDAy4HmZyg.jpg);"> 
                <div class="overlay">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-12">
            ...
            <div class="hero-bg-01" data-jarallax='{"speed": 0.6}' style="background-image:url(assets/images/menu/imgonline-com-ua-resize-O5vjE7Ee466aD.jpg);">
                <div class="overlay">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                    ...
                    <div class="col-lg-7 col-md-12 col-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6" id="sabermaisx">
                                <a href="{{ route('site.sobrenos') }}" class="btn btn-secondary mt-60 xs-mt-20">
                                    <i class="flaticon-right icon-arrow before"></i>
                        ...
                        <div class="col-xl-12">
                                    ...
                                    <div class="project-item swiper-slide">
                                        ...
                                        <div class="content-btn">
                                            <div class="content-btn-text">
                                                ...
                                                <span id="botija">{{__('messages.Botija')}}</span>
                                            </div>
									 ...
									 <div class="project-item swiper-slide">
                                        ...
                                        <div class="image">
                                          ...
                                          <div class="content">
                                            <h4 class="title"><a href="{{ route('site.botija_5kg_compact') }}" id="5kgc">{{__('messages.5kgc')}}</a></h4>
                                            <span id="botija">{{('messages.botija')}}</span>
                                        </div>
                                    ...
                                    <div class="project-item swiper-slide">
                                        ...
                                        <div class="content-btn">
                                            <div class="content-btn-text">
                                                ...
                                                <span id="botija5">{{__('messages.botija5')}}</span>
                                            </div>
							...
							<!--		 <div class="project-item swiper-slide">
                                    ...
                                    <div class="project-item swiper-slide">
                                        ...
                                        <div class="content-btn">
                                            <div class="content-btn-text">
                                                <h4 class="title"><a href="{{ route('site.botija_45kg') }}" id="45kg">{{__('messages.45kg')}}</a></h4>
                                                <span id="botija5">{{__('messages.botija5')}}</span>
                                            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="footer-widget widget mt-50 footer-about">
                            ...
                            <div class="logo mt-30 mb-30">
                                <a href="###"> <img src="{{ asset('assets/images/MyGas_mocambique.jpg') }}" alt="footer logo"></a>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6">
                        <div class="footer-widget widget mt-50">
                            ...
                            <ul class="mt-20">
                                <li><a href="#!"><i class="fa fa-angle-right" id="sobrenoss"></i></a></li>
                                <li><a href="#!"><i class="fa fa-angle-right" id="produtosabaprodutos"></i></a></li>
                                <li><a href="#!"><i class="fa fa-angle-right" id="pontosvendas"></i></a></li>
                                <li><a href="#!"><i class="fa fa-angle-right" id="renvendedores"></i></a></li>
                                <li><a href="#!"><i class="fa fa-angle-right" id="contactoss"></i></a></li>
                            </ul>
                        </div>
                    </div>
               <!--    <div class="col-lg-3 col-sm-6 col-md-6">
